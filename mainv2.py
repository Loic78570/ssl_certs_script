...
if __name__ == "__main__":
    ...
    root_cert, root_privatekey = generate_root_CA(subject,
    ...
    client_csr, client_privatekey = generate_csr(subject_cert=subject,
    ...
    serveur_csr, serveur_privatekey = generate_csr(subject_cert=subject,
                                                   issuer_cert=subject)  # Generate CSR and private key
    ...
    prof_csr, prof_privatekey = generate_csr(subject_cert=subject,
                                             issuer_cert=subject)   # Generate CSR and private key
    ...
    student_csr, student_privatekey = generate_csr(subject_cert=subject,
                                                   issuer_cert=subject)   # Generate CSR and private key

    os.makedirs("CA_ROOT_DEV/CA_CLIENT/STUDENT/", exist_ok=True)    # Create directory for Student CA in Client CA directory
